					...
					<div class="card-wrapper swiper-wrapper">
						<div class="card swiper-slide">
							<div class="image-content">
								<div class="card-image">
									<img class="card-img" src="images/news.jpg">
								</div>
							</div>

							<div class="card-content">
								<p class="headline">Dr. Stone Season 3 Premiere Will Be Everything Fans Hoped It Would Be even more eowr WEOROEOROASDS dfsfes</p>
							</div>
						</div>
						<div class="card swiper-slide">
							<div class="image-content">
						...
						<div class="card swiper-slide">
							<div class="image-content">
								...
								<div class="card-image">
									<img class="card-img" src="images/news2.jpg">
								</div>
							</div>
