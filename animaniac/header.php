...
<header class="main-header" id="top">
    ...
    <div class="search-filter-container">
        ...
        <div class="search">
            <form action="searchResult.php" method="POST">
                <input type="text" required placeholder="Search..." name="search_query" value="<?php echo isset($_SESSION['search_query']) ? $_SESSION['search_query'] : ''; ?>">
                <button type="submit">
    ...
    <div class="icons">
        ...
        <a href="user-login.php" class="user">
