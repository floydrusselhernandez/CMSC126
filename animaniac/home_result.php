...
$selectedTags = isset($_GET['tag']) ? $_GET['tag'] : [];

// Retrieve selected genre checkboxes
$selectedGenres = isset($_GET['genre']) ? $_GET['genre'] : [];

// Apply sorting and retrieve the sorted and filtered result
$result = applySorting($selectedOption, $selectedCategories, $selectedGenres, $selectedTags);
...
<head>
    ...
    <link rel="stylesheet" href="css/home_result.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="icon" type="image/png" href="res/logo1.png">
    <script src="js/home_result.js"></script>
    <title>Shop</title>
</head>
...
<body>
    ...
    <?php 
        ...
        //         <h1 style="text-transform: uppercase;">'.$tag.'</h1>
        //     </div>';
    ?>
    ...
    <div class="content-container">
        <table class="wishitems">
            <tr>
                ...
                <div class="tag">
                    <label for="tag"><br>Tag:</label><br>
                    <input type="radio" id="trending" name="tag" value="trending">
                    <label for="trending">Trending</label><br>
                    <input type="radio" id="popular" name="tag" value="popular">
                    <label for="popular">Popular</label><br>
                    <input type="radio" id="special_promo" name="tag" value="special_promo">
                    <label for="special_promo">Special Promo</label><br>
                    <input type="radio" id="new_arrival" name="tag" value="new_arrival">
