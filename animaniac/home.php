...
<body>
	...
	<div class="image-container">
		<a href="home_result.php?sortby=null&tag=trending">
	...
	<table>
		<tr>
			<td id="promoData">
				<a href="home_result.php?sortby=null&tag=special_promo">
	...
	<a href="home_result.php?sortby=null&tag=special_promo"><button id="shopNow">Shop Now</button></a>

	<div class="image-container">
		<a href="home_result.php?sortby=null&tag=popular">
	...
	<table>
		<tr>
			<td id="newArrivalData">
				<a href="home_result.php?sortby=null&tag=new_arrival">
		...
		<tr>
			<td id="categoryData">
				<div class="catImgContainer">
					<a href="home_result.php?sortby=null&categories=books">
			...
			<td id="categoryData">
				<div class="catImgContainer">
					<a href="home_result.php?sortby=null&categories=figures">
			...
			<td id="categoryData">
				<div class="catImgContainer">
					<a href="home_result.php?sortby=null&categories=clothing">
	...
	<table>
		<tr>
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=adventure">
			...
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=action">
			...
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=comedy">
			...
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=drama">
		...
		<tr>
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=fantasy">
			...
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=horror">
			...
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=romance">
			...
			<td id="genreData">
				<div class="genreImgContainer">
					<a href="home_result.php?sortby=null&genre=sci-fi">
