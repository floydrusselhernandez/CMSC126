...
function openPopup(productId) {
  ...
  function applyFilter() {
    ...
    // Get selected tag checkboxes
    var selectedTags = getSelectedCheckboxes('tag');
    ...
    var filterUrl = 'home_result.php?sortby=' + encodeURIComponent(existingSortBy);
    ...
    if (selectedTags.length > 0) {
      filterUrl += '&tag=' + encodeURIComponent(selectedTags.join(','));
    }
  ...
  function initializeFilters() {
    ...
    var selectedTags = getParameterByName('tag');
    ...
    if (selectedTags) {
      ...
      var tagCheckboxes = document.querySelectorAll('input[name="tag"]');
