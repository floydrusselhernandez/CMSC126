...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2023 at 02:05 AM
...
(21, 1, 10, '2023-06-06 23:31:34'),
(22, 1, 12, '2023-06-06 23:31:34');
...
(2, 'Moderoid SSSS.Dynazenon Dynazenon', 'res/products/figures/figure2.png', 'From Good Smile Company’s Moderoid line of plastic models that are fun to build and display comes the titular mech Dynazenon from the popular anime SSSS.Dynazenon! The model features seven color-separated runners and pre-painted parts, so it’ll look amazi', 9499.00, 2, 1),
(3, 'Uchusen Bessatsu SSSS.Dynazenon', 'res/products/books/book1.png', 'From the tag team of Tsuburaya Productions and TRIGGER comes a mook that serves as the perfect compendium to their new generation robot anime SSSS.Dynazenon! Spanning 95 pages, Uchusen Bessatsu SSSS.Dynazenon features must-see content spanning the entire ', 500.00, 1, 6),
(4, 'LISTEN FLAVOR Hatsune Miku Jersey Hoodie', 'res/products/clothes/clothes1.png', 'Introducing a collaboration between Harajuku fashion brand LISTEN FLAVOR and Vocaloid Hatsune Miku! Available in a unisex free size in either black or emerald, this 100% polyester hoodie has a two-tone design with turquoise accents, a double zipper up the', 1000.00, 3, 4),
(5, 'Nendoroid Death Note L 2.0 (Re-run)', 'res/products/figures/figure3.png', 'The world-renowned detective in search of Kira returns to the world of Nendoroid!\r\nFrom the popular anime series Death Note comes L looking as disheveled and languid as ever in chibi form. An all-new updated version over the previous release, he comes wit', 2520.45, 2, 6),
...
(10, 'hololive Collaboration Ookami Mio Model Glasses', 'res/products/clothes/clothes2.png', '\"Hellooowl! It’s Ookami Mio!\"\r\nFrom high quality glasses maker Shitsuji Megane Eye Mirror in collaboration with the popular VTuber group hololive production comes glasses inspired by gaming VTuber Ookami Mio! The glasses feature a stainless steel frame th', 6707.44, 3, 1),
...
(12, 'LISTEN FLAVOR x Danganronpa Nagito Komaeda\'s Madne', 'res/products/clothes/clothes4.png', 'Add some stylish Danganronpa flair to your look! Part of a collaboration between popular Japanese Harajuku fashion brand LISTEN FLAVOR and Danganronpa, this pullover hoodie features artwork of “Ultimate Lucky Student” Nagito Komaeda front and center looki', 2794.44, 3, 2),
(13, 'Nendoroid Kaguya-sama: Love Is War -The First Kiss', 'res/products/figures/figure5.png', '\"Ideas without ideals are meaningless.\"\r\nFrom the anime movie Kaguya-sama: Love Is War -The First Kiss That Never Ends- comes a Nendoroid figure of Shuchi\'in Academy’s determined and somewhat overbearing student council auditor and member of the Public Mo', 2090.10, 2, 2),
