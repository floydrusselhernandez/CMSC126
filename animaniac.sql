...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2023 at 04:07 PM
...
(11, 'Oshi no Ko Anime Debuts in 2023 with 90-Minute 1st Episode', 'res/news/denji-chainsaw-man-figure-shibuya-scramble.png', 'res/news/article2.jpg', '2023-05-24', '\r\nGenerated Lorem Ipsum\r\n\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Sed ullamcorper morbi tincidunt ornare massa. Hendrerit gravida rutrum quisque non tellus orci ac. Ac placerat vestibulum lectus mauris ultrices eros in. Vitae congue eu consequat ac felis donec et. Ultrices dui sapien eget mi proin sed libero enim sed. Gravida cum sociis natoque penatibus et. Vestibulum rhoncus est pellentesque elit ullamcorper dignissim cras tincidunt. Pellentesque massa placerat duis ultricies lacus sed turpis tincidunt. Erat pellentesque adipiscing commodo elit at imperdiet dui. Auctor neque vitae tempus quam pellentesque nec nam aliquam. Porttitor rhoncus dolor purus non enim praesent. Aliquam ut porttitor leo a diam sollicitudin tempor id eu. Sagittis eu volutpat odio facilisis mauris. Massa tempor nec feugiat nisl pretium fusce. Ut sem viverra aliquet eget sit amet. Diam vel quam elementum pulvinar.', '\r\nGenerated Lorem Ipsum\r\n\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Sed ullamcorper morbi tincidunt ornare massa. Hendrerit gravida rutrum quisque non tellus orci ac. Ac placerat vestibulum lectus mauris ultrices eros in. Vitae congue eu consequat ac felis donec et. Ultrices dui sapien eget mi proin sed libero enim sed. Gravida cum sociis natoque penatibus et. Vestibulum rhoncus est pellentesque elit ullamcorper dignissim cras tincidunt. Pellentesque massa placerat duis ultricies lacus sed turpis tincidunt. Erat pellentesque adipiscing commodo elit at imperdiet dui. Auctor neque vitae tempus quam pellentesque nec nam aliquam. Porttitor rhoncus dolor purus non enim praesent. Aliquam ut porttitor leo a diam sollicitudin tempor id eu. Sagittis eu volutpat odio facilisis mauris. Massa tempor nec feugiat nisl pretium fusce. Ut sem viverra aliquet eget sit amet. Diam vel quam elementum pulvinar.');
...
(8, 11, 'The Devil Is a Part-Timer!! Anime\'s Sequel Series Unveils More Cast, Songs, July 13 Debut in 2nd Video', 'res/news/maousama2_kv.jpg', 'The official website for The Devil Is a Part-Timer!! (with two exclamation points), the second anime based on Satoshi Wagahara\'s The Devil Is a Part-Timer!! light novel series, started streaming the sequel\'s second promotional video on Wednesday. The video previews the new anime\'s opening and ending theme songs and also announces three new cast members and its July 13 premiere.', 'anime', 'popular', 0, 1),
...
(15, 11, 'New CCS Toys Lazengann Gurren Lagann Figure Unveiled', 'res/news/ccs-toys-lazengann-gurren-lagann-figure-new.png', 'A new CCS Toys Lazengann Gurren Lagann figure was announced. The Lazengann is piloted by Lordgenome in Gurren Lagann, one of my top mecha anime on Netflix. It is a black mecha with a martial artist-like physique that has a tail, which it is uses for attacks, and a helmet, which features a single horn. All of these details have been faithfully recreated by CCS Toys.', 'product', 'new arrival', 0, 1),
(16, 11, 'Best Anime and Manga Black Friday & Cyber Monday Deals 2023', 'res/news/bf.png', 'The Holiday season is about to be upon us, which means that sites and stores are about to reveal their Black Friday and Cyber Monday 2023 sales. Here are all of the anime and manga Black Friday deals and Cyber Monday deals that have been announced so far for 2023! We will continue to update this post as new deals and sales go live.', 'promotion', 'trending', 0, 1),
(17, 11, 'Best Upcoming Manga Deals and Sales', 'res/news/manga-deals-2023.png', 'Manga deals and sales happen all throughout the year, but unless you are subscribed to every newsletter and check sites weekly, it can be difficult to keep track of them all. I\'ve been collecting manga for years, so I know firsthand how easy it is to miss out on a good deal or sale. With this in mind, I wanted to create a post outlining all of the manga sales and deals that take place throughout the year in hopes that it will be helpful to those of you who are looking for cheap manga deals.', 'promotion', 'new arrival', 0, 1),
(18, 11, 'New Taito Rascal Does Not Dream of Bunny Girl Senpai Mai Sakurajima Figure Announced', 'res/news/mai.png', 'Taito revealed a new Mai Sakurajima figure from Rascal Does Not Dream of Bunny Girl Senpai. Many figures of Mai Sakurajima have been released in the past, but this one is unique, because she is wearing a Chinese dress and it shows her lounging in a crescent moon in a dreamy landscape.', 'product', 'new arrival', 0, 1),
(19, 11, 'Every Licensed Anime Statue Releasing in 2023', 'res/news/anime-statues-2023.png', 'As anime continues to grow in popularity, the number of licensed anime statues that release within a year increase, which is exciting because more and more licenses are being obtained by licensed studios and more characters and scenes from anime are being brought to life in statue form.', 'product', 'hot', 0, 1),
(20, 11, 'Anime Merch Frenzy: Massive Sale Unleashed, Otaku Rejoice!', 'res/news/anime-scale-figures-2024.png', 'A lot of amazing anime scale figures released in 2023 and 2024 is looking like it\'s going to be no exception, with all of the new anime figures that have already been revealed by eStream, FREEing, FuRyu, Good Smile Company, Kadokawa, Kotobukiya, and more.', 'promotion', 'hot', 0, 1);
...
INSERT INTO `search` (`search_id`, `searchtxt`) VALUES
(211, 'pop'),
(212, 'pop'),
(213, 'pop'),
(214, 'pop'),
...
(1, 'rainerRainer', 'rainergw@po.com'),
(2, 'SeanPdope', 'seanP@gmail.com'),
(3, 'DavidBrown', 'davidbrown@example.com'),
(4, 'EmilyJohnson', 'emilyjohnson@example.com'),
(5, 'Rainer', 'rtmayagma@sample.com');
...
(49, 1, 8, '2023-06-08 04:47:31'),
(50, 1, 12, '2023-06-08 04:47:39'),
(51, 1, 11, '2023-06-08 04:47:42');
...
--
ALTER TABLE `search`
  MODIFY `search_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=218;
...
--
ALTER TABLE `wishlist`
  MODIFY `wishlist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
